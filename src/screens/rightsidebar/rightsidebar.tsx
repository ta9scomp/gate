  ...
  return (
    <div>
      <div className="content">
        <HamburgerButton onClick={() => setShowRightSidebar(!showRightSidebar)} />
      </div>


      <div className={showRightSidebar ? 'rightsidebar rightsidebar-show' : 'rightsidebar rightsidebar-hidden'}>
        <h2
